...
/*menu*/
// Adicione esta função para alternar a visibilidade do menu dropdown em telas pequenas
function toggleDropdown() {
  var dropdownMenu = document.getElementById("myDropdown");
  dropdownMenu.style.display = dropdownMenu.style.display === "block" ? "none" : "block";
}

// Adicione este evento para chamar a função ao clicar no botão do menu dropdown
